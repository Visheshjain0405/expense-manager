          ...
          <div key={idx} className="bg-brand-surface border border-brand-border rounded-2xl p-6 h-48 flex flex-col justify-between">
            ...
            <div className="space-y-2">
              <div className="flex justify-between">
                <div className="h-4 w-16 bg-slate-250 rounded-md"></div>
                <div className="h-3.5 w-10 bg-slate-200 rounded-md"></div>
              </div>
              <div className="w-full bg-slate-100 h-2 rounded-full"></div>
            </div>

            <div className="border-t border-slate-50 pt-2.5 flex justify-between">
              <div className="h-3.5 w-12 bg-slate-150 rounded-md"></div>
