...
export default function DeleteNetWorthItemModal({ isOpen, onClose, onConfirm, isDeleting = false }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-brand-surface border border-brand-border w-full max-w-sm rounded-2xl shadow-xl flex flex-col p-6 animate-zoom-in text-center select-none">
        ...
        <h3 className="text-base font-bold text-text-main">Delete this financial item?</h3>
        <p className="text-xs text-text-secondary mt-1.5 leading-relaxed">
          This will remove it from your net worth calculation.
        </p>
